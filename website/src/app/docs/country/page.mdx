---
title: Country codes
description: Learn how to use country codes with HeroTelInput.
---
...
These codes can be used for the [onlyCountries](/docs/api), [excludedCountries](/docs/api) and [preferredCountries](/docs/api) properties of MuiTelInput.
